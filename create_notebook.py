"""
Generates Databricks / Jupyter Notebook (.ipynb) for Topic 06: UPI Transaction Fraud Signals
"""

import json

def build_notebook(output_file="Project/Databricks_Notebook_UPI_Fraud_Signals.ipynb"):
    notebook = {
        "cells": [
            {
                "cell_type": "markdown",
    ...
    print(f"[SUCCESS] Created Databricks Notebook: {output_file}")
